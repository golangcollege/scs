...
An in-memory session store, this is the default store for [SCS](https://github.com/golangcollege/scs) if none of the others stores are used.
...
import (
	...
	"github.com/golangcollege/scs/v2/memstore"
)
